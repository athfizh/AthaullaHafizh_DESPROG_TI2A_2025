<div class="container-fluid">
    <div class="row">
        ...
        $id = $_GET['id']; // Ini adalah user_id
        $query = "SELECT *, a.nama as nama_anggota, j.jabatan as nama_jabatan 
                  FROM anggota a
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama" value="<?= $row['nama_anggota']; ?>">
                                </div>
                                <div class="mb-3">
