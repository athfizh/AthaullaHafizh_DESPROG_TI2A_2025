<div class="container-fluid">
    <div class="row">
        ...
        $query_anggota = "SELECT count(id) as jel FROM anggota";
        $result_anggota = mysqli_query($koneksi, $query_anggota);
        $row_anggota = mysqli_fetch_assoc($result_anggota);
        
        $query_jabatan = "SELECT count(id) as jel FROM jabatan";
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Total anggota sejumlah <?php echo $row_anggota['jel']; ?> orang.</p>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Total jabatan sejumlah <?php echo $row_jabatan['jel']; ?>.</p>
