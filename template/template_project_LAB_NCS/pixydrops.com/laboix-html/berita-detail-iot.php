<?php
// file: berita-detail-iot.php (Komentar Dihapus Total)
...
<section class="page-header">
    ...
    <div class="container">
        ...
        <ul class="nionx-breadcrumb list-unstyled">
            ...
            <li><span>Analisis Kerentanan...</span></li>
        </ul>
    </div>
</section>
                ...
                <div class="blog-details">
                    <div class="blog-card__two">
                        ...
                        <div class="blog-card__two__content">
                            ...
                            <h3 class="blog-card__two__title blog-card__two__title--two"><a href="#">Analisis Kerentanan Terbaru pada IoT Campus</a></h3>
                            ...
                            <ul class="sidebar__posts list-unstyled">
                                <li class="sidebar__posts__item">
                                    ...
                                    <div class="sidebar__posts__content">
                                        ...
                                        <h4 class="sidebar__posts__title"><a href="berita-detail-ctf.php">Tim Lab NCS Raih Juara 1 Kompetisi CTF</a></h4>
                                    </div>
                                </li>
                                <li class="sidebar__posts__item">
                                    <div class="sidebar__posts__image">
                                    ...
                                    <div class="sidebar__posts__content">
                                        ...
                                        <h4 class="sidebar__posts__title"><a href="berita-detail-jurnal.php">Publikasi Jurnal: Implementasi Zero Trust</a></h4>
                                    </div>
                                </li>
                            </ul>
                        </div>
